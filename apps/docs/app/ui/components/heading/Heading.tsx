    ...
    return (
        <div className={clsx("hd-heading", className)}>
            <div className="hd-heading__banner">
                <p><span className="hd-heading__banner-title">Preview Only: </span>These components are for reference only. Continue using <a className="hd-heading__banner-link" href="https://wl-orbiter-website.netlify.app/">Orbiter</a> in production until further notice.</p>
            </div>
