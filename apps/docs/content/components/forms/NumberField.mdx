---
title: NumberField
description: A number field is a specialized number field that allows a user to enter a number.
category: "forms"
links:
...
### ReadOnly
The `isReadOnly` prop makes the number field's text content immutable. Unlike `isDisabled`, the number field remains focusable and the contents can still be copied. See [the MDN docs](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/readonly) for more information.
