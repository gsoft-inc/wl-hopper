...
TagGroups can be different sizes using the `size` prop.

<Example src="tag/docs/tagGroup/sizes" />

### Variants

TagGroups can have different styles using the `variant` prop. The one seen here is `subdued`.
...
An individual tag can be disabled using the `isDisabled` prop.

<Example src="tag/docs/tag/disabled" />

### Invalid

An individual tag can be set as invalid using the `isInvalid` prop.

<Example src="tag/docs/tag/invalid" />

### Sizes

An individual tag can be different sizes using the `size` prop.

<Example src="tag/docs/tag/sizes" />

### Variants

An individual tag can have different styles using the `variant` prop.

<Example src="tag/docs/tag/variants" />

### Loading

Tags can have a loading state using the `isLoading` prop.

<Example src="tag/docs/tag/loading" />

### Avatar

A tag can have an avatar.

<Example src="tag/docs/tag/avatar" />

### Icons

Tags can have an icon or an icon list.

<Example src="tag/docs/tag/icons" />

### Count

Tags can have a count using the `Badge` component.
