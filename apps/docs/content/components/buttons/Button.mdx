...
**Upsell** - For upsell actions that relate to upgrading an account or a plan. Use the upsell button to distinguish it from an existing primary button. In some cases, a primary button can be used in its place when the general context of the page is about upselling.
