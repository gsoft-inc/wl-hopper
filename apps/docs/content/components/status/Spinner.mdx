---
title: Spinner
description: A spinner indicates that a part of the product is currently performing a task, and the duration of this process is unknown.
category: "status"
links:
...
### Label
A spinner can have a label on the side.
