...
To make a disclosure inline, set the `variant` prop to `inline`. 
This is typically used when placing a disclosure inside a container. In this example, it's inside a `Card` component.

<Example src="Disclosure/docs/inline" />
