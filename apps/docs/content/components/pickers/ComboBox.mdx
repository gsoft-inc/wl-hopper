...
### Custom Value
A combo box's trigger value can be customized using the `renderValue` function to allow other elements such as an avatar or icon inside the trigger value.

<Example src="Combobox/docs/customValue" />
