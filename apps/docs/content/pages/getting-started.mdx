...
You are now ready to use Hopper UI in your project! Need more details? Keep reading for a more detailed installation guide.

## Detailed Installation

### Components

Hopper Components are React Comtponents, if you are using another framework, or React Native, you should use the [components tokens](/tokens/getting-started/introduction) directly when developping your own components.
...
#### Framework agnostic installations
