...
Margin refers to the traditional meaning of space between elements. It can be used as a margin or gap when in grid or flex layouts. It is refered as stack in Hopper. The last element of a stack should omit this space.
...
Inline refers to the space that separates inline elements arranged horizontally and that may wrap on the right.
