...
- **Working with spaces** - Space is the distance between two objects in your design. It should be used to complement the purpose of a page, by creating hierarchy and helping the content become more useful and understandable.
- **Be harmonious** - Use Hopper DS space tokens in a way that is consistent with the rest of the experience. Some spaces are used in specific context, so be sure to follow the proper documentation to apply space at the right places.
