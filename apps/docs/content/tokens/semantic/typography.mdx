...
Hopper components already compensate for this issue. You might need to do the same when *ABC Favorit* is used in a boxed component not provided by Hopper.
