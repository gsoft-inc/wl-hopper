...
Colours are one of the most obvious way to convey meaning in design. Depending on its context of use and on the amount of time we see them, we start to associate colour with meaning. Each of the colours used in the Workleap ecosystem complements each other and have a specific role to play.
...
Each colour have assigned sentiment, based on how they function within the interface. Defined colour roles make things easy to modify and customize later. Their meaning is also expanded to all Workleap verticals so that users understand that they’re in the same ecosystem and can recognize its codes.
