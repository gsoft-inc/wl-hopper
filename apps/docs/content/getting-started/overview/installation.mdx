...
<CardLinkList>
    <CardLink href="#" title="React Applications" description="The most common way to integrate Hopper." key="1">
    ...
    <CardLink href="#" type="secondary" title="Other Frameworks or Libraries" description="Use Hopper seamlessly with other JavaScript or TypeScript-based setups." key="2">
