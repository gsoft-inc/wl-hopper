...
_Image of an icon with the different parts labeled._
...
_Image of an the three sizes available._

#### Stroke Alignment

_Image of a the two allowed alignments in Hopper._
...
_Image of an icon with the keylines visible._
