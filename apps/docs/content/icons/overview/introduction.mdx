...
<CardLinkList>
    <CardLink href="/getting-started/individual-packages#icons" title="React Icons Package" description="Designed specifically for React applications, this package offers all icons as React components." size="sm" />
    <CardLink href="/getting-started/javascript#svg-icons" title="SVG Icons Package" description="Ideal for non-React setups, this package provides raw SVG files." size="sm" />
</CardLinkList>
