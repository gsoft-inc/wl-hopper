...
The following variables are available for your styling needs: `--hop-Richicon-placeholder-fill`, `--hop-Richicon-placeholder-background`. You should use the appropriate [decorative semantic tokens](/tokens/semantic/color#decorative), the available options for Rich Icons are `option1`, `option2`, `option3`, `option4`, `option5`, `option6`, `option7` and `option8`.
