...
The color of the rich icons can be changed by using the `variant` prop. The following [decorative colors]() are available for the rich icons: `option1, option2, option3, option4, option5, option6, option7, option8`
