...
<Tabs tabs={installMethods}>
    <div>
    ```shell
    pnpm add @hopper-ui/icons @hopper-ui/styled-system
    ```
    </div>
    <div>
    ```shell
    yarn add -D @hopper-ui/icons @hopper-ui/styled-system
    ```
    </div>
    <div>
    ```shell
    npm add -D @hopper-ui/icons @hopper-ui/styled-system
    ```
    </div>
</Tabs>
