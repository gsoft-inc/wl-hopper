...
const InlineCopyButton = ({ text, className }: InlineCopyButtonProps) => {
    ...
    return (
        ...
        >
            {isCopied ? <svg width="24" height="24" className="hd-inline-copy-button__icon" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="m5 11.75 5 5 9-9.5"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ></path>
            </svg> : <svg width="16" height="16"className="hd-inline-copy-button__icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
