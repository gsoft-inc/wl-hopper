...
export const DarkSemanticTokens = {
    ...
    "--hop-danger-surface-press": "var(--hop-amanita-300)",
    ...
    "--hop-danger-text-selected": "var(--hop-amanita-300)",
    ...
    "--hop-primary-text-press": "var(--hop-sapphire-400)",
    ...
    "--hop-upsell-border-selected": "var(--hop-sunken-treasure-500)",
    ...
    "--hop-upsell-icon-press": "var(--hop-sunken-treasure-800)",
    ...
    "--hop-upsell-surface-press": "var(--hop-sunken-treasure-400)",
    ...
    "--hop-upsell-text-press": "var(--hop-sunken-treasure-800)",
