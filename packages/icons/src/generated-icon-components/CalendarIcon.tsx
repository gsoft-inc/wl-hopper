...
const CalendarIcon32 = forwardRef((props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => <svg width={32} height={32} fill="none" viewBox="0 0 32 32" focusable="false" ref={ref} {...props}><path fill="currentColor" fillRule="evenodd" d="M12 5a1 1 0 1 0-2 0v1H8a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-2V5a1 1 0 1 0-2 0v1h-8zm12 7V8h-2v1a1 1 0 1 1-2 0V8h-8v1a1 1 0 1 1-2 0V8H8v4zM8 14v10h16V14z" /></svg>);
