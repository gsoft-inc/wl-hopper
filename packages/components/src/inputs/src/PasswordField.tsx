...
export interface PasswordFieldProps extends StyledComponentProps<RACTextFieldProps> {
    /**
...
function TextField(props:PasswordFieldProps, ref: ForwardedRef<HTMLDivElement>) {
